...
class RL_Field_City implements RL_Field_Interface, RL_Field_Processing_Interface
{
	...
	public function render(array $field, $value, array $context = []): void
	{
		...
		$options = call_user_func($geo, $field, 'city', is_array($options_state) ? $options_state : []);
	...
	public function sanitize(array $field, $value, array $context = [])
	{
		...
		$allowed = array_keys(call_user_func($geo_callback, $field, 'city', $context['validation_context'] ?? []));
